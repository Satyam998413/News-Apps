...
export class News extends Component {
  ...
  async updateNews() {
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=${this.state.apikeys}&page=${this.state.page}&pageSize=${this.props.pageSize}`;
    ...
    return (
      <>
        ...
        <div className='container my-3'>
          <h1 className="text-center"><u>NewsCremen-Top  HeadLines</u></h1>
